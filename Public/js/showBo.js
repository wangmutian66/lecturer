...
Showbo.Msg={  
    ...
    prompt:function(labelWord,defaultValue,txtId,fn){  
      ...
      this.show({title:'输入提示',msg:labelWord+'<input type="password" id="'+txtId+'" style="width:200px" value="'+defaultValue+'"/>',buttons:{yes:'确认',no:'取消'},fn:fn});  
    },  
    ...
    show:function(cfg){  
      ...
      if(cfg.wait){  
        ...
        this.dvBottom.style.height='75px';  
