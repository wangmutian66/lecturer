...
b+"']").length)){var e=d.find("footer").find("a").removeClass("pressed").attr("data-ignore-pressed","true");e.filter("[href='"+b+"']").addClass("pressed");e.filter("[href='#"+b+"']").addClass("pressed")}},showBackButton:function(a,d){var b=this.views[a.prop("id")].length,e=a.children("header");0!==e.length&&(2<=b&&!0!==d?1!==e.find(".backButton").length&&(e.prepend("<a class='backButton back'>"+this.backButtonText+"</a>"),e.on("click",".backButton",function(){this.useInternalRouting&&this.goBack(this)})):
e.find(".backButton").remove())},loadAjax:function(c,d,b,f,g){var k=this,h=e(c),n=a(".panel[data-crc='"+h+"']"),p=g.getAttribute("data-refresh");if(0<n.length)if(p)k.showLoading&&k.showMask("Loading"),a.ajax(c).then(function(a){n.html(a);k.showLoading&&k.hideMask();return k.loadContent("#"+n.prop("id"),d,b,f,g)});else return k.loadContent("#"+n.prop("id"),d,b,f,g);k.showLoading&&k.showMask("Loading");a.ajax(c).then(function(e){e=a.create("div",{html:e});e.hasClass(".panel")?e=e.find(".panel"):
(e=a(g).attr("data-title")?e.attr("data-title",g.getAttribute("data-title")):a(g).attr("title")?e.attr("data-title",g.getAttribute("title")):e.attr("data-title",c),e.prop("id",h),e.addClass("panel"));a(k.activeDiv).closest(".pages").append(e);e.attr("data-crc",h);k.showLoading&&k.hideMask();k.loadContent("#"+e.prop("id"),d,b,f,g)}).fail(function(a){k.showLoading&&k.hideMask();console.log("Error with ajax request",a)})},runTransition:function(c,b,e,f,g){c||(c="slide");-1!==c.indexOf(":back")&&(c=c.replace(":back",
""),f=!0);var k=this,h=f?b:e,n=f?e:b;b=!1;-1!==c.indexOf("-reveal")&&(c=c.replace("-reveal",""),b=!0);a(h).css("zIndex","10");a(n).css("zIndex","1");a(g).css("zIndex","1").addClass("active");e=a(n).animation().remove(c+"-in");!b&&e&&(f&&e.reverse(),e.end(function(){if(f)this.classList.add("active"),a(this).trigger("panelload",[f]);else{this.classList.remove("active");var c=a(this).find(".active").get(0);void 0!==c&&c.classList.remove("active");a(this).trigger("panelunload",[f])}k.doingTransition=
!1}).run(c+"-out"));h=a(h).animation().remove(c+"-out");f&&h.reverse();h.end(function(){k.doingTransition=!1;if(f){g&&a(g).css("zIndex","10");this.classList.remove("active");var c=a(this).find(".active").get(0);void 0!==c&&c.classList.remove("active");a(n).trigger("panelload",[f]);a(n).addClass("active");a(this).trigger("panelunload",[f])}else this.classList.add("active"),a(this).trigger("panelload",[f]),a(g).trigger("panelload",[f]),c=a(n).find(".active").get(0),void 0!==c&&c.classList.remove("active"),
...
this.views[a.prop("id")].push({target:b,transition:e}))},launch:function(){if(!1===this.hasLaunched||this.launchCompleted)this.hasLaunched=!0;else{if(this.isLaunching)return!0;this.isLaunching=!0;this.blockPageBounce();var c=this,d=a.create("div",{id:"afui_mask",className:"ui-loader",html:"<span class='ui-icon ui-icon-loading spin'></span><h1>加载中</h1>"}).css({"z-index":2E4,display:"none"});document.body.appendChild(d.get(0));d=a(".view[data-default='true']");if(0===d.length&&(d=a(".view").eq(0),
