(function($){
	...
	//MT 添加
	function childAnimate(element){
		/*$(element).find("h1").removeClass("title");
		$(element).children(".intro").css("left","-50%");
		
	    setTimeout(function(){
			$(element).children(".intro").stop().animate({"left":"25%"},800);
			$(element).find("h1").addClass("title")
		},1000);
		**/
	}
